...
public class UpdateHomestay extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_update_homestay);
        ...
        // untuk mengakses data, memanggil semua data dari tabel homestay sesuai dengan nama yang dipilih
        cursor = db.rawQuery("SELECT * FROM homestay WHERE nama_home = '" +
                getIntent().getStringExtra("nama_home") + "'",null);
        ...
        btn1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                // Untuk mengeksekusi sintaks SQL mengupdate data homestay sesuai dengan nama yang dipilih
                db.execSQL("UPDATE homestay SET nama_home='"+
                        text2.getText().toString() +"', alamat='" +
                        text3.getText().toString() +"', fasilitas='" +
                        text4.getText().toString() + "' WHERE id_home='" +
